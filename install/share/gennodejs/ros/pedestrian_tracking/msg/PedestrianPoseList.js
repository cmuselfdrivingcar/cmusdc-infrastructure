...
let PedestrianPose = require('./PedestrianPose.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PedestrianPoseList {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.poses.forEach((val) => {
      bufferOffset = PedestrianPose.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PedestrianPoseList(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.poses[i] = PedestrianPose.deserialize(buffer, bufferOffset)
    }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PedestrianPoseList(null);
    ...
    if (msg.poses !== undefined) {
      ...
      for (let i = 0; i < resolved.poses.length; ++i) {
        resolved.poses[i] = PedestrianPose.Resolve(msg.poses[i]);
      }
    }
    else {
      resolved.poses = []
...
module.exports = PedestrianPoseList;
