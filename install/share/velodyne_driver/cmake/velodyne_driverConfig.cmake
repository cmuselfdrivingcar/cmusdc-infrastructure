...
if("FALSE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/teame16/CMUSelfDrivingCar/src/sensors/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/teame16/CMUSelfDrivingCar/devel)
  ...
  set(velodyne_driver_INSTALL_PREFIX /home/teame16/CMUSelfDrivingCar/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/teame16/CMUSelfDrivingCar/install/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
